            ...
            <div class="card-body">
                ...
                <form v-on:submit.prevent="actualizarRegistro">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" required name="img_cat" v-model="categoria.img_cat" id="img_cat" aria-describedby="helpId" placeholder="Tipo">
...
export default {
    ...
    methods:{
        obtenerInformacionID(){
            fetch('http://localhost/categoria/?consultar='+this.$route.params.id_cat)
        ...
        actualizarRegistro(){
            var datosEnviar = {
                id: this.$route.params.id_cat,
                img_cat: this.empleado.img_cat, 
                descripcion: this.empleado.descripcion
            }

            fetch('http://localhost/categoria/?actualizar='+this.$route.params.id_cat,{
                method: 'POST',
